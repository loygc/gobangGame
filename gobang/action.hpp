...
bool load_files() {
    ...
    draw = load_image("resource/pic/draw.bmp");
    button = load_image("resource/pic/button.bmp");
    hand = load_image("resource/pic/hand.bmp");
    ...
    //Load the music
    music = Mix_LoadMUS("resource/sound/background.ogg");
    ...
    drop = Mix_LoadWAV("resource/sound/drop.wav");
    bomb = Mix_LoadWAV("resource/sound/bomb.wav");
